    ...
    <div className="greetingBanner">
      ...
      <div className="greetingText">
        <p>
          ...
          <p>
            Наша компания является официальным представителем в Украине (Вы
            можете ознакомиться с нашими сертификатами, перейдя по следующим
            ссылкам)
            ...
            дилером других, представленных на сайте брендов, тем самым,
          ...
          <p>
            ...
            конкурсов, мастер-классов для музыкантов, хотелось бы высказать
            особую благодарность нашим клиентам!!!{" "}
          </p>
        </p>
      </div>
    </div>
